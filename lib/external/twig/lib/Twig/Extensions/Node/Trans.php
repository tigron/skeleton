...
class Twig_Extensions_Node_Trans extends Twig_Node
{
    ...
    public function __construct(Twig_NodeInterface $body, Twig_NodeInterface $plural = null, Twig_Node_Expression $count = null, $lineno, $tag = null, $options = array())
    {
    ...
    public function compile(Twig_Compiler $compiler)
    {
        ...
        $function = null === $this->getNode('plural') ? $this->function_translation : $this->function_translation_plural;
